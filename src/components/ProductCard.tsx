...
const RECOMMEND_TITLE: Record<string, string> = {
  dehumidifier: "노써치가 추천하는 최고의 제습기🥇\n습한 여름, 쾌적한 실내를 위한 필수 가전!",
  steam_iron: "노써치가 추천하는 최고의 스팀다리미🥇\n구김 없는 깔끔한 옷매무새의 비결!✨",
  blender: "노써치가 추천하는 최고의 블렌더🥇\n초고속 분쇄력으로 건강한 식단을 완성!",
  mop_cleaner: "노써치가 추천하는 최고의 물걸레청소기🥇\n깔끔한 바닥을 위한 똑똑한 선택!",
  dish_washer: "노써치가 추천하는 최고의 식기세척기🥇\n설거지 스트레스에서 해방!✨",
  humidifier: "노써치가 추천하는 최고의 가습기🥇\n촉촉한 실내를 위한 필수 가전!",
  air_fryer: "노써치가 추천하는 최고의 에어프라이어🥇\n바삭한 요리를 간편하게!",
  beam_projector: "노써치가 추천하는 최고의 빔프로젝터🥇\n홈시네마의 완성🎬 집이 영화관으로!✨",
  fan_heater: "노써치가 추천하는 최고의 온풍기🥇\n따뜻한 겨울을 위한 똑똑한 선택!",
  cordless_vacuum_cleaner: "노써치가 추천하는 최고의 무선청소기🥇\n가벼운 무게, 강력한 흡입력!",
  bathroom_heater: "노써치가 추천하는 최고의 욕실난방기🥇\n추운 겨울 욕실을 따뜻하게!",
  electric_pot: "노써치가 추천하는 최고의 전기포트🥇\n빠르고 편리한 물 끓이기!",
  bath_towel: "노써치가 추천하는 최고의 수건🥇\n부드럽고 흡수력 좋은 프리미엄 타올!",
  smart_trash_can: "노써치가 추천하는 최고의 스마트 휴지통🥇\n자동 센서로 편리하게!",
  water_toothpick: "노써치가 추천하는 최고의 구강세정기🥇\n치아 건강을 위한 스마트한 선택!",
  wireless_charger: "노써치가 추천하는 최고의 무선충전기🥇\n간편한 충전, 깔끔한 데스크!",
  electric_mattress: "노써치가 추천하는 최고의 전기요🥇\n포근한 겨울밤을 위한 필수템!",
  robotic_vacuum_cleaner: "노써치가 추천하는 최고의 로봇청소기🥇\n자동으로 깨끗한 바닥!",
  electric_fan: "노써치가 추천하는 최고의 선풍기🥇\n시원한 여름을 위한 스마트 선택!",
  shoulder_massage: "노써치가 추천하는 최고의 어깨안마기🥇\n뭉친 어깨를 시원하게!",
  water_purifier: "노써치가 추천하는 최고의 정수기🥇\n깨끗한 물, 건강한 생활!",
  bidet: "노써치가 추천하는 최고의 비데🥇\n쾌적한 욕실 생활의 시작!",
  garbage_disposer: "노써치가 추천하는 최고의 음식물처리기🥇\n냄새 없는 깨끗한 주방!",
  air_circulator: "노써치가 추천하는 최고의 써큘레이터🥇\n효율적인 공기 순환!",
  hair_dryer: "노써치가 추천하는 최고의 헤어드라이어🥇\n빠른 건조, 부드러운 모발!",
  bluetooth_earphone: "노써치가 추천하는 최고의 블루투스 이어폰🥇\n선 없는 자유로운 음악!",
};

const RECOMMEND_DESC: Record<string, string> = {
  dehumidifier: "뛰어난 제습 성능과 에너지 효율로 인정받은 제품을 노써치 공동구매 최저가로 만나보세요!",
  steam_iron: "강력한 스팀과 편리한 사용성으로 인정받은 제품을 노써치 공동구매 최저가로 만나보세요!",
  blender: "강력한 분쇄력과 다양한 기능으로 인정받은 제품을 노써치 공동구매 최저가로 만나보세요!",
};
...
export default function ProductCard({ product }: { product: Product }) {
  ...
  const title = RECOMMEND_TITLE[product.productCategoryKey || ""] ||
    `노써치가 추천하는 최고의 ${product.categoryName}🥇\n전문가가 직접 써보고 추천하는 제품!`;
  const desc = RECOMMEND_DESC[product.productCategoryKey || ""] ||
    "우수한 성능으로 인정받은 제품을 노써치 공동구매 최저가로 만나보세요. 수량한정 할인가를 놓치지 마세요!";
  ...
  return (
    <article className="w-full overflow-hidden bg-blue-1 p-[20px]">
      ...
      <div className="relative w-full shrink-0">
        <div className="relative w-full bg-white" style={{ aspectRatio: "16 / 9" }}>
          <Image
            ...
            alt={product.goodsNm}
            fill
            className={`object-contain p-[20px] ${isSoldOut ? "opacity-40" : ""}`}
      ...
      <div className="mt-[12px]">
        ...
        <div className="border-t border-gray-3 pt-[12px]">
          <p className="mb-[4px] line-clamp-1 break-all text-[22px] font-extrabold leading-[33px] text-gray-10">
            {productName}
          </p>
