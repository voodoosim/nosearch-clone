...
const BANNERS: Record<string, BannerConfig> = {
  storeHome: {
    ...
    statUnit: "명",
    statLabel: "누적 구매 고객",
    bg: "linear-gradient(135deg, #060E1C 0%, #0D1E38 45%, #081828 100%)",
    accent: "#5B9CF6",
    accentDim: "rgba(91,156,246,0.10)",
  ...
  deal: {
    ...
    statUnit: "명",
    statLabel: "이번달 구매 완료",
    bg: "linear-gradient(135deg, #041210 0%, #091F18 45%, #0B2C1E 100%)",
    accent: "#2ECC7A",
    accentDim: "rgba(46,204,122,0.10)",
    accentGlow: "rgba(46,204,122,0.18)",
    special: "progress",
    progress: 74,
  ...
  best: {
    ...
    statUnit: "건",
    statLabel: "이번주 누적 구매",
    bg: "linear-gradient(135deg, #060E1C 0%, #0C1A30 45%, #081424 100%)",
    accent: "#5B9CF6",
    accentDim: "rgba(91,156,246,0.10)",
    accentGlow: "rgba(91,156,246,0.18)",
  },
  rental: {
    ...
    bg: "linear-gradient(135deg, #0C0C18 0%, #141428 45%, #10101E 100%)",
    accent: "#9B7CF8",
    accentDim: "rgba(155,124,248,0.10)",
    accentGlow: "rgba(155,124,248,0.20)",
  },
  exhibition: {
    label: "CURATION",
    eyebrow: "테마별 특별 기획전",
    ...
    statUnit: "개",
    statLabel: "기획전 참여 상품",
    bg: "linear-gradient(135deg, #080E08 0%, #101A10 45%, #0C1410 100%)",
    accent: "#2EC4A0",
    accentDim: "rgba(46,196,160,0.10)",
    accentGlow: "rgba(46,196,160,0.20)",
  },
};
